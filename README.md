...
| `_Other/NBlood.rbf` | The FPGA core image. |
...
Then supply your own Blood game data in `/media/fat/games/NBlood/` (see `games/NBlood/README_DATA.md`), and start **NBlood** from MiSTer's `_Other` menu.
